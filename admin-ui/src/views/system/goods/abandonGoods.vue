<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="mallList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="下架时间" align="center" prop="updateTime" />
...
<script>
  import { getMallSpecs,storeList,listMall, getMall, delMall, addMall, updateMall,getMallSku,updateMallSku,insertMallSku,getMallSpecsChilds } from "@/api/system/goods";
