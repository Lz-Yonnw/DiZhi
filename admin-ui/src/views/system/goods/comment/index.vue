<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="评价类型" prop="typeName">
        <el-input
    ...
    <el-table v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="评价类别" align="center" prop="typeId" />
      <el-table-column label="评价类型" align="center" prop="typeName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="评价类型" prop="typeName">
          <el-input v-model="form.typeName" placeholder="请输入评价类型" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除评价类型编号为"' + typeIds + '"的数据项？').then(function() {
