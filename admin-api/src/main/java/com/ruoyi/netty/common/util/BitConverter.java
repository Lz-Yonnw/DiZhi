...
public class BitConverter {
    ...
    //原本是4位，舍弃高位，最大数值为32767，short
    public static byte[] to2Byte(int n) {
        byte[] b = new byte[2];
        b[0] = (byte) (n & 0xff);
        b[1] = (byte) (n >> 8 & 0xff);
        return b;
...
//        byte[] bytes2= BitConverter.to2Byte(81054);
//        System.out.println("b="+ Arrays.toString(bytes2));
//        short s2 =BitConverter.toShort(bytes2,0);
//        System.out.println(s2);
//        System.out.println(s2-Short.MIN_VALUE+Short.MAX_VALUE+1);


        byte[] bytes = BitConverter.toLH(80000);
        System.out.println("bytes="+ Arrays.toString(bytes));
        System.out.println("int="+ BitConverter.toInt(bytes));
...
//
////        byte[] bb= new byte[]{34, 0, 104,0,30,0};
//        short s1 =BitConverter.toShort(b,0);
//        short s2 =BitConverter.toShort(b,2);
